export const ru = {
  ...
  "op.exportHtmlError": "Не удалось экспортировать HTML",
  ...
  "op.exportHtmlErrorPrefix": "Ошибка при экспорте HTML: ",
  ...
  "preview.latexCompiling": "Компиляция LaTeX…",
  "preview.latexError": "LaTeX:",
  "preview.latexEmpty": "Пустой документ LaTeX.",
  "preview.latexNotice": "Для предпросмотра LaTeX нужны пакеты TeX Live с настроенной конечной точки.",
