export const zh = {
  ...
  "op.exportingHtml": "正在导出 HTML…",
  "op.opened": "文件已打开",
  "op.saved": "文档已保存",
  "op.pdfExported": "PDF 已导出",
  "op.htmlExported": "HTML 已导出",
  "op.openError": "无法打开文件",
  "op.saveError": "无法保存文档",
  "op.exportError": "无法导出 PDF",
  "op.exportHtmlError": "无法导出 HTML",
  ...
  "preview.pages": "页",
  "preview.latexCompiling": "正在编译 LaTeX…",
  "preview.latexError": "LaTeX:",
  "preview.latexEmpty": "LaTeX 文档为空。",
  "preview.latexNotice": "LaTeX 预览需要从配置的端点获取 TeX Live 宏包。",
