export const ur = {
  ...
  "menu.about": "meditor کے بارے میں",
  "about.title": "meditor کے بارے میں",
  "about.tagline": "ڈیسک ٹاپ کے لیے مقامی Markdown، Typst اور LaTeX ایڈیٹر۔",
  "about.version": (v: string) => `ورژن ${v}`,
