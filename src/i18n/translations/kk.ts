export const kk = {
  ...
  "op.exportHtmlErrorPrefix": "HTML экспорттау қатесі: ",
  ...
  "menu.exportHtml": "HTML экспорттау",
  "menu.newTab": "Жаңа бет",
  "menu.closeAll": "Close all tabs",
  "menu.preferences": "Параметрлер",
  "menu.shortcut.preferences": "Ctrl+,",
  "prefs.title": "Параметрлер",
  "prefs.close": "Параметрлерді жабу",
