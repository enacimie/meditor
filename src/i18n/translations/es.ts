export const es = {
  ...
  "op.reloading": "Recargando…",
  "op.reloadError": "No se pudo recargar el documento",
  "op.reloadErrorPrefix": "No se pudo recargar: ",
  "op.reloaded": (name: string) => `${name} recargado desde el disco`,
  ...
  "confirm.reloadDiscards": (name: string) =>
    `"${name}" tiene cambios sin guardar. Recargar toma el fichero tal como está en el disco y los descarta. ¿Recargar de todos modos?`,
  ...
  "editor.search.replaceField": "Reemplazar",
  "editor.search.next": "siguiente",
  "editor.search.previous": "anterior",
  "editor.search.all": "todas",
  "editor.search.matchCase": "distinguir mayúsculas",
  "editor.search.regexp": "expresión regular",
  "editor.search.byWord": "palabra completa",
  "editor.search.replace": "reemplazar",
  "editor.search.replaceAll": "reemplazar todas",
  "editor.search.currentMatch": "coincidencia actual",
  "editor.search.onLine": "en la línea",
  "editor.search.replacedMatches": "$ coincidencias reemplazadas",
  "editor.search.replacedMatchOnLine": "coincidencia reemplazada en la línea $",
  "editor.gotoLine.label": "Ir a línea",
  "editor.gotoLine.go": "ir",
  "editor.fold.foldLine": "Plegar línea",
  "editor.fold.unfoldLine": "Desplegar línea",
  "editor.fold.foldedCode": "código plegado",
  "editor.fold.unfold": "desplegar",
  "editor.fold.foldedLines": "Líneas plegadas",
  "editor.fold.unfoldedLines": "Líneas desplegadas",
  "editor.fold.to": "a",
  "editor.close": "cerrar",
  "editor.selectionDeleted": "Selección eliminada",
  "editor.controlCharacter": "Carácter de control",
  "editor.completions": "Sugerencias",
  "editor.diagnostics": "Diagnósticos",
  "editor.noDiagnostics": "Sin diagnósticos",
  ...
  "menu.reload": "Recargar del disco",
  ...
  "prefs.pageMargin": "Margen de la página",
  "prefs.pageMarginHint": "El blanco alrededor del texto en la vista Documento y en su PDF. El número de página y el título corrido van dentro de él.",
  "prefs.pageMarginValue": (mm: number) => `${mm} mm`,
  ...
  "preview.tableRef": (n: number) => `tabla ${n}`,
  "preview.equationRef": (n: number) => `ec. ${n}`,
  ...
  "shortcuts.link": "Insertar enlace",
  ...
  "preview.typstFilesUnsaved": "Guarda el documento para que Typst pueda leer los archivos que tiene al lado.",
  "preview.typstFilesDesktopOnly": "Solo la aplicación de escritorio puede darle a Typst los archivos que hay junto a un documento.",
  "preview.typstFilesLeftOut": "Typst no ha recibido estos archivos:",
  "preview.typstFileOutside": "solo se leen archivos de la carpeta del documento, y no los ocultos",
  "preview.typstFileUnsupported": "no es un tipo de archivo que se le dé a Typst",
  "preview.typstFileTooLarge": (mib: number) => `ocupa más de ${mib} MiB`,
  "preview.typstFileLimit": (files: number, mib: number, depth: number) =>
    `supera lo que puede leer un documento: ${files} archivos, ${mib} MiB, ${depth} niveles de include`,
