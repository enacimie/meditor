export const es = {
  ...
  "tab.activeDoc": "Documento activo",
  ...
  "pane.scrollToCodeHint": "Ir al código en la posición marcada (haz clic en la vista previa para marcar)",
  ...
  "session.restoreError": "No se pudo restaurar la sesión",
  "session.saveError": "No se pudo guardar la sesión",
  "native.dialogError": "No se pudo mostrar el aviso nativo",
  "pdf.exportError": "Error al exportar PDF: ",
  ...
  "pdf.cancelled": "Exportación cancelada",
  ...
  "menu.shortcut.prevTab": "Ctrl+Mayús+Tab",
  ...
  "topbar.newLatexTitle": "Nuevo documento LaTeX",
  "topbar.newLatexAria": "Nueva pestaña LaTeX",
