...
type Props = {
  ...
  onCloseOthers: () => void;
  onAbout: () => void;
  /** Absent where updates cannot happen: the browser build and mobile. */
  onCheckUpdates?: () => void;
  onPreferences?: () => void;
        ...
        <div className="menu-dropdown" ref={menuRef}>
          ...
          {menuOpen && (
            <div id="app-menu" className="menu-panel" role="menu" aria-label={t("topbar.moreOptions")} onKeyDown={handleMenuKeyDown}>
              ...
              {onCheckUpdates && (
              <button type="button" role="menuitem" disabled={busy} onClick={() => { onCheckUpdates(); setMenuOpen(false); menuToggleRef.current?.focus(); }}>
