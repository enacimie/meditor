...
- **Title, author and date** from the front-matter become a title block at the head of the document. With a title there, the running head carries the document's name on every page instead of the chapter it is in, and the exported PDF is titled with it rather than with the file's name — a Marp deck's too.
